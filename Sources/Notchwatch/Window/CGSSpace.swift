// CGSSpace.swift
// Private Apple API wrapper for custom window spaces
// Source: https://github.com/avaidyam/Parrot/ (MPL 2.0)

import AppKit

/// Small Spaces API wrapper for creating windows that appear on all spaces at the highest level
